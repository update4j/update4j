...
You can [download](https://repo1.maven.org/maven2/org/update4j/update4j/1.5.2/update4j-1.5.2.jar) or install using Maven:
...
```shell
$ java -p update4j-1.5.2.jar -m org.update4j
